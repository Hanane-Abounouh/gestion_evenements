    ...
    <section class="bg-white dark:bg-gray-900 ml-5">
        <div class="py-8 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="{{ route('events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-yellow-600 rounded-lg focus:ring-4 focus:ring-yellow-600 dark:focus:ring-yellow-600 hover:bg-yellow-700">
                    Update Event
                </button>
            </form>
        </div>
